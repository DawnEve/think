...
class WeiboLogic{
    function links(){
        return array(
			...
			array('javascript:void(0);','新闻news','_____________________________________________________________________________________'),
			...
			/*人物-名人*/
			array('javascript:void(0);','人物-名人','_____________________________________________________________________________________'),
			...
			/*商业-经管类*/
			array('javascript:void(0);','商业-经管类','_____________________________________________________________________________________'),
			...
			array('https://www.time.com/','时代周刊','《时代周刊》（Time）又称《时代》，创立于1923年，是半个世纪多以前最先出现的新闻周刊之一，特为新的日益增长的国际读者群开设一个了解全球新闻的窗口。《时代》是美国三大时事性周刊之一，内容广泛，对国际问题发表主张和对国际重大事件进行跟踪报道。'),
			array('https://www.bna.com/','国际事务局','彭博社 Bloomberg BNA provides resources that enable legal, tax, compliance, government affairs, and government contracting professionals to make more informed decisions, provide strategic advice, grow their businesses, and remain compliant.'),
			
			
			/*科技类*/
			array('javascript:void(0);','科技类','_____________________________________________________________________________________'),
            ...
            array('http://www.scientificamerican.com/','科学美国人','准确预测全球科学未来的发展趋势，并将科研界的成果和人们的实际应用联系在一起，成为制订政府和企业科技政策和发展战略的首选参考，深入了解各领域科技动态的最佳指南。很多考试中往往涉及到自然科学和生物学领域的内容。因此，对于此类内容最佳的教材，就是著名的科学类读物《科学美国人》(Scientific American)。'),
			...
			/*国内en站点*/
			array('javascript:void(0);','国内英文网站','_____________________________________________________________________________________'),
